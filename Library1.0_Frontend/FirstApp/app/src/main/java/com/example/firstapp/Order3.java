...
public class Order3 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner1 = (Spinner)super.findViewById(R.id.yd3_spinner1);
        ...
        Spinner2 = (Spinner)super.findViewById(R.id.yd3_spinner2);
        ...
        Btn2=findViewById(R.id.yd3_button);
        Btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Order3.this,"发送成功",Toast.LENGTH_LONG).show();
            }
        });
    }
