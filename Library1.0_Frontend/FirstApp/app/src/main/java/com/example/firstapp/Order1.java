...
public class Order1 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner1 = (Spinner)super.findViewById(R.id.yd1_spinner1);
        ...
        Spinner2 = (Spinner)super.findViewById(R.id.yd1_spinner2);
        ...
        Btn2=findViewById(R.id.yd1_button);
        Btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Order1.this,"发送成功",Toast.LENGTH_LONG).show();
            }
        });
    }
