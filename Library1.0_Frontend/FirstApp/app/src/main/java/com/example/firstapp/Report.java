...
public class Report extends BaseActivity {
    ...
    private List<CharSequence> List3 = null;
    private ArrayAdapter<CharSequence> Adapter3 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner1 = (Spinner)super.findViewById(R.id.jb_spinner1);
        ...
        Spinner3 = (Spinner)super.findViewById(R.id.jb_spinner3);
        Spinner3.setPrompt("请选择您想举报的类型:");
        List3 = new ArrayList<CharSequence>();
        List3.add("吵闹");
        List3.add("吃东西");
        List3.add("打游戏/睡觉");
        List3.add("以物占座");
        List3.add("其他");
        Adapter3 = new ArrayAdapter<CharSequence>(this,android.R.layout.simple_spinner_item,List3);
        Adapter3.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        Spinner3.setAdapter(Adapter3);

        Spinner2 = (Spinner)super.findViewById(R.id.jb_spinner2);
        ...
        Spinner1.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Adapter2 = new ArrayAdapter<CharSequence>(Report.this,android.R.layout.simple_spinner_item,List2);
                Adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                Spinner2.setAdapter(Adapter2);
        ...
        mReportButton = findViewById(R.id.jb_button);
        mReportButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Report.this,"发送成功",Toast.LENGTH_LONG).show();
            }
        });
    }
}
